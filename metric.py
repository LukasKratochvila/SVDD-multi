#https://github.com/scikit-learn/scikit-learn/blob/f4e692c08/sklearn/metrics/_ranking.py#L1572
...
from utils import type_of_target
from utils import _encode, _unique
